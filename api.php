...
$ricette = [
    ...
    "felice" => [
        ...
        "message"      => "Un piatto fresco e profumato come te.",
        "time_minutes" => 20,
        "difficulty"   => "facile",
        "servings"     => 2,
        "ingredients"  => [
    ...
    "stanco" => [
        ...
        "message"      => "Questo piatto ti rimette in piedi senza stancarti ulteriormente.",
        "time_minutes" => 30,
        "difficulty"   => "facile",
        "servings"     => 2,
        "ingredients"  => [
    ...
    "triste" => [
        ...
        "message"      => "Un abbraccio a forma di piatto",
        "time_minutes" => 25,
        "difficulty"   => "media",
        "servings"     => 2,
        "ingredients"  => [
    ...
    "arrabbiato" => [
        ...
        "message"      => "Con questo piatto puoi sfogarti sui peperoncini.",
        "time_minutes" => 20,
        "difficulty"   => "facile",
        "servings"     => 2,
        "ingredients"  => [
    ...
    "romantico" => [
        ...
        "message"      => "Amerai per forza il tartufo.",
        "time_minutes" => 25,
        "difficulty"   => "media",
        "servings"     => 2,
        "ingredients"  => [
    ...
    "avventuroso" => [
        ...
        "message"      => "Un piatto di mare che non ti aspetti.",
        "time_minutes" => 15,
